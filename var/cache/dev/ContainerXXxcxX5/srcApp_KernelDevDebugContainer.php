...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('s7jpzL+ICY', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pNJJ1lwha5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9vINfhXkVI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4QRix3COpr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Fv93HSwXKE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1h6osT1sLp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tSsLU6EpWi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder8342b = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer4a086 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesa5857 = [
        
    ];

    public function getConnection()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getConnection', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getMetadataFactory', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getExpressionBuilder', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'beginTransaction', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getCache', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getCache();
    }

    public function transactional($func)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'transactional', array('func' => $func), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->transactional($func);
    }

    public function commit()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'commit', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->commit();
    }

    public function rollback()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'rollback', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getClassMetadata', array('className' => $className), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'createQuery', array('dql' => $dql), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'createNamedQuery', array('name' => $name), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'createQueryBuilder', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'flush', array('entity' => $entity), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'clear', array('entityName' => $entityName), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->clear($entityName);
    }

    public function close()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'close', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->close();
    }

    public function persist($entity)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'persist', array('entity' => $entity), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'remove', array('entity' => $entity), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'refresh', array('entity' => $entity), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'detach', array('entity' => $entity), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'merge', array('entity' => $entity), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getRepository', array('entityName' => $entityName), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'contains', array('entity' => $entity), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getEventManager', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getConfiguration', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'isOpen', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getUnitOfWork', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getProxyFactory', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'initializeObject', array('obj' => $obj), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'getFilters', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'isFiltersStateClean', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'hasFilters', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return $this->valueHolder8342b->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer4a086 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder8342b) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder8342b = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder8342b->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, '__get', ['name' => $name], $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        if (isset(self::$publicPropertiesa5857[$name])) {
            return $this->valueHolder8342b->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder8342b;
    ...
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;
    ...
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, '__isset', array('name' => $name), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;
    ...
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, '__unset', array('name' => $name), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;
    ...
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, '__clone', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        $this->valueHolder8342b = clone $this->valueHolder8342b;
    }

    public function __sleep()
    {
        $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, '__sleep', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;

        return array('valueHolder8342b');
    }
    ...
    {
        $this->initializer4a086 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer4a086;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer4a086 && ($this->initializer4a086->__invoke($valueHolder8342b, $this, 'initializeProxy', array(), $this->initializer4a086) || 1) && $this->valueHolder8342b = $valueHolder8342b;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder8342b;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder8342b;
    }
}
